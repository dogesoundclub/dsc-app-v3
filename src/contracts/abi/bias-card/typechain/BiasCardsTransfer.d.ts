...
interface BiasCardsTransferInterface extends ethers.utils.Interface {
  functions: {
...
export class BiasCardsTransfer extends Contract {
  ...
  interface: BiasCardsTransferInterface;
