...
import CollapsibleFilter from "../component/EmateCollapsibleFilter";
...
export default class EmateGallery implements View {
    ...
    constructor() {
        BmcsLayout.current.title = "E-MATE GALLERY";
        BmcsLayout.current.content.append(
            this.container = el(".emate-gallery-view",
                el("header",
                    el("h1", "GALLERY"),
                ),
                el("section",
