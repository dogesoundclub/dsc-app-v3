            ...
            el("section",
                ...
                el(".buy-mate",
                    el(".card",
                        ...
                        el(".button-wrap",
                            el("button", msg("OPENSEA_BUTTON")),
                            el("button", msg("KLUBS_BUTTON")),
                        ),
                    ),
                ...
                el(".nft",
                    ...
                    el("section",
                        ...
                        el("article",
                            ...
                            el(".button-container",
                                el("button", msg("HOME_NFT_BUTTON1")),
                                el("button", msg("HOME_NFT_BUTTON2")),
                            ),
                            el("hr"),
                            el("p", "Mates can be purchased at Opensea."),
                            el(".caption", msg("HOME_NFT_DESC2")),
                            el(".button-container",
                                el("button", msg("HOME_NFT_BUTTON3")),
                            ),
                            el(".image-wrap",
