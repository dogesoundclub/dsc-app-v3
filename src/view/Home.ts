        ...
        Layout.current.content.append(this.container = el(".home-view",
            el("header",
                el(".content",
                    ...
                    el("button", "Enter", { click: () => ViewUtil.go("/mates") }),
                ),
            ),
            el("section",
                el(".dogesound",
                ...
                el(".buy-mate",
                    el(".card",
                        ...
                        el(".button-wrap",
                            ...
                            el("a", "KLUBS", { href: "https://klu.bs/pfp/0xE47E90C58F8336A2f24Bcd9bCB530e2e02E1E8ae", target: "_blank" }),
                        ),
                    ),
                ...
                el(".nft",
                    ...
                    el("section",
                        ...
                        el("article",
                            ...
                            el(".button-container",
                                el("button", "Go to see more about NFT", { click: () => ViewUtil.go("/mates") }),
                                el("button", "What can you do with this?", { click: () => ViewUtil.go("/activities") }),
                            ),
                            el("hr"),
