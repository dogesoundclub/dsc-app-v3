            ...
            (this.container = el(".bmcs-view",
                ...
                el("section",
                    ...
                    el("article.roadmap-container section #roadmap",
                        ...
                        el(".content",
                            el(".card-container",
                                el(".card.complete-card", { click: () => { new BMCSAlert(msg("BMCS_ROADMAP_ALERT_TITLE1"), msg("BMCS_ROADMAP_ALERT_DESC1"), "OK") } },
                                ...
                                el(".card.complete-card", { click: () => { new BMCSAlert(msg("BMCS_ROADMAP_ALERT_TITLE2"), msg("BMCS_ROADMAP_ALERT_DESC2"), "OK") } },
                                    el("img.complete", { src: "/images/view/bmcs/home/complete.png", alt: "complete" }),
                                    el("h4", "000%"),
