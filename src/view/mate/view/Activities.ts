    ...
    constructor() {
        ...
        Layout.current.content.append(this.container = el(".activities-view.hiding-buttons",
            ...
            el("section",
                ...
                el("hr"),
                el("article",
                    el("img", { src: "/images/mate/view/activities/dsc_fam.png" }),
                ...
                el("hr"),
                el("article",
                    el("img", { src: "/images/mate/view/activities/mymate.png" }),
                ...
                el("hr"),
                el("article",
                    el("img", { src: "/images/view/activities/competition.png" }),
                ...
                el("hr"),
                el("article",
                    el("img", { src: "/images/view/activities/governance.png" }),
