    ...
    constructor() {
        ...
        BodyNode.append(
            (this.container = el(".bmcs-view",
                el(".nav",
                    el(".left",
                        el("a.menu-button", el("img", { src: "/images/view/bmcs/icn_menu.svg" }), {
                            click: (event, button) => {
                ...
                el("section",
                    ...
                    el("hr"),
                    el("article#biasedMate.biased-mate-container section",
                    ...
                    el("hr"),
                    el("article#biasCards.vibe-container section",
                    ...
                    el("hr"),
                    el("article#roadmap.roadmap-container section",
                        ...
                        el(".content",
                            el(".card-container",
                                el(".card", { click: () => { new BMCSAlert(msg("BMCS_ROADMAP_ALERT_TITLE1"), msg("BMCS_ROADMAP_ALERT_DESC1"), "OK") } },
                                    ...
                                    el("img.right", { src: "/images/view/bmcs/icn-arrow-right.svg" }),
                                ),
                                ...
                                el(".card", { click: () => { new BMCSAlert(msg("BMCS_ROADMAP_ALERT_TITLE3"), msg("BMCS_ROADMAP_ALERT_DESC3"), "OK") } },
                                    ...
                                    el("img.down", { src: "/images/view/bmcs/icn-arrow-down.svg" }),
                                ),
                            ),
                            el(".card-reverse-container",
                                el(".card", { click: () => { new BMCSAlert(msg("BMCS_ROADMAP_ALERT_TITLE4"), msg("BMCS_ROADMAP_ALERT_DESC4"), "OK") } },
                                    ...
                                    el("img.left", { src: "/images/view/bmcs/icn-arrow-left.svg" }),
                                ),
                    ...
                    el("hr"),
                    el("article#faq.faq-container section",
                        el("h2", "FAQ"),
                    ...
                    el("hr"),
                    el("article#partnership.partnership-container section",
                        el("h2", "PARTNERSHIP"),
                        el("h3", "DSC LABEL"),
                        el(".content",
                ...
                el("footer",
                    el(".sidebar",
                        el(".content",
                            ...
                            el(".social",
                                el("img", { src: "/images/view/bmcs/icn_linktree.svg" }),
                                el("a", "링크트리 바로가기", {
