...
const Unstaking_1 = __importDefault(require("./view/bmcs/view/Unstaking"));
...
(async () => {
    ...
    skyrouter_1.SkyRouter.route(["bmcs", "bmcs/mates/{id}", "bmcs/gallery", "bmcs/cycle-of-craft", "bmcs/preparation", "bmcs/unstaking", "bmcs/selected-mate/{mateId}/{cardId}", "bmcs/progress/{mateId}/{cardId}", "bmcs/done/{biasId}"], Layout_2.default);
    ...
    skyrouter_1.SkyRouter.route("bmcs/unstaking", Unstaking_1.default);
