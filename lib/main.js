...
const Home_1 = __importDefault(require("./view/mate/view/eMate/Home"));
const Layout_1 = __importDefault(require("./view/mate/view/eMate/Layout"));
...
const Home_2 = __importDefault(require("./view/mate/view/Home"));
const Layout_2 = __importDefault(require("./view/mate/view/Layout"));
...
(async () => {
    ...
    skyrouter_1.SkyRouter.route("**", Layout_2.default, ["bmcs", "emate"]);
    skyrouter_1.SkyRouter.route("", Home_2.default);
    ...
    skyrouter_1.SkyRouter.route("**", Layout_1.default, ["bmcs", "", "followMe", "holder", "buyMate", "activities",
        ...
        "terms", "faq"]);
    skyrouter_1.SkyRouter.route("e-mate", Home_1.default);
