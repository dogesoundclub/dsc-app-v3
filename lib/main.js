...
(async () => {
    ...
    skyrouter_1.SkyRouter.route(["bmcs", "bmcs/gallery", "bmcs/cycle-of-craft", "bmcs/preparation", "bmcs/selected-mate/{mateId}/{cardId}", "bmcs/progress/{mateId}/{cardId}", "bmcs/done/{biasId}"], Layout_2.default);
