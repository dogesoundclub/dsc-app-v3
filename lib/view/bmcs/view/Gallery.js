...
const BMCSCollapsibleFilter_1 = __importDefault(require("../component/BMCSCollapsibleFilter"));
...
class BmcsGallery {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".bmcs-gallery-view", (0, skynode_1.el)("header", (0, skynode_1.el)("h1", (0, msg_js_1.default)("GALLERY_TITLE"))), (0, skynode_1.el)("section", (0, skynode_1.el)(".filter", (0, skynode_1.el)(".input-container", (0, skynode_1.el)("input", {
            ...
            const select = new BMCSCollapsibleFilter_1.default(key, values, {
                click: (event, select) => {
