...
class Unstaking {
    constructor() {
        ...
        }, (0, skynode_1.el)("img", { src: "/images/shared/icn/icn_close.svg" }))), this.mateList = (0, skynode_1.el)(".mate-container"), (0, skynode_1.el)("hr"), (0, skynode_1.el)(".detail", (0, skynode_1.el)("h2", "1 BMCS 당 언스테이킹 가능 믹스 수량"), this.mixPrice = (0, skynode_1.el)(".price", "...")), (0, skynode_1.el)(".button-wrap", (0, skynode_1.el)("a", "언스테이킹", {
            click: async () => {
