...
class CycleOfCraftCard extends skynode_1.DomNode {
    constructor(id, metadata, currentBlock, startBlock, level, claimableCount) {
        ...
        if (startBlock === 0 || level === 0) {
            level = parseInt((metadata.attributes.find((a) => a.trait_type === "Crafting Speed")?.value.substring("Level ".length)));
            this.append((0, skynode_1.el)(".info-container", (0, skynode_1.el)("img", { src: metadata.image, alt: "bmcs" }, { click: () => ViewUtil_1.default.go(`/bmcs/mates/${id}`) }), (0, skynode_1.el)(".title", metadata.name), (0, skynode_1.el)("a", "제작 진행률 확인", {
                click: async () => {
            ...
            })), (0, skynode_1.el)(".progress-container", (0, skynode_1.el)("img", { src: "/images/view/bmcs/cycle-of-craft/loading.png", alt: "loading" }), (0, skynode_1.el)(".progress"), (0, skynode_1.el)(".content", (0, skynode_1.el)("p", "새로 얻은 BMCS는 제작 진행률 트랜잭션이 필요합니다."))));
        }
        else {
            let speed = 0;
            if (level === 1) {
            ...
            let bar;
            this.append((0, skynode_1.el)(".info-container", (0, skynode_1.el)("img", { src: metadata.image, alt: "bmcs" }, { click: () => ViewUtil_1.default.go(`/bmcs/mates/${id}`) }), (0, skynode_1.el)(".title", metadata.name), (0, skynode_1.el)("a", "엔진 받기", {
                click: () => {
