...
class MateItem extends skynode_1.DomNode {
    constructor(list, id, name, selectable, showingRarity) {
        ...
        this.append((0, skynode_1.el)("img", { src: `https://storage.googleapis.com/dsc-mate/336/dscMate-${id}.png` }), (0, skynode_1.el)("span.id", `#${id} ${name}`));
        ...
        this.onDom("click", () => {
            if (selectable === true) {
                ...
                ViewUtil_1.default.go(`/bmcs/mates/${id}`);
            }
        });
    }
}
