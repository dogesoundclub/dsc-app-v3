...
const EmateCollapsibleFilter_1 = __importDefault(require("../component/EmateCollapsibleFilter"));
const MateParts_json_1 = __importDefault(require("../../mate/view/mates/MateParts.json"));
const Mates_json_1 = __importDefault(require("../../mate/view/mates/Mates.json"));
const MateList_1 = __importDefault(require("../../mate/component/mate/MateList"));
class EmateGallery {
    constructor() {
        this.selects = [];
        this.filter = {};
        ...
        Layout_1.default.current.title = "E-MATE GALLERY";
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".emate-gallery-view", (0, skynode_1.el)("header", (0, skynode_1.el)("h1", "GALLERY")), (0, skynode_1.el)("section", (0, skynode_1.el)(".filter", (0, skynode_1.el)(".input-container", (0, skynode_1.el)("input", {
            ...
            const select = new EmateCollapsibleFilter_1.default(key, values, {
                click: (event, select) => {
