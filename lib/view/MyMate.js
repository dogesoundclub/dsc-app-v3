...
class MyMate {
  constructor() {
    ...
    Layout_1.default.current.content.append(
      (this.container = (0, skynode_1.el)(
        ...
        (0, skynode_1.el)(
          "header",
          (0, skynode_1.el)("h1", (0, msg_js_1.default)("MY_MATE_TITLE")),
          (0, skynode_1.el)(
            "h2",
            (0, msg_js_1.default)("MY_MATE_WALLET_ADDRESS")
          ),
          (this.wallet = (0, skynode_1.el)("p"))
        ),
        (0, skynode_1.el)(
          "section",
          ...
          (0, skynode_1.el)(
            ...
            (0, skynode_1.el)(
              "h2",
              (0, msg_js_1.default)("HOLDER_DISCORD_CERTIFICATION_TITLE")
            ),
            (0, skynode_1.el)(
              "p",
              (0, msg_js_1.default)("HOLDER_DISCORD_CERTIFICATION_DESC")
            ),
            (0, skynode_1.el)(
              "a",
              (0, msg_js_1.default)("HOLDER_DISCORD_CERTIFICATION_BUTTON"),
              {
                href: `https://discord.com/api/oauth2/authorize?client_id=1074340739930140682&redirect_uri=${encodeURIComponent(
                  `${window.location.protocol}//${window.location.host}/myMate`
    ...
    if (address !== undefined) {
      ...
      try {
        const result = await fetch(
          "https://api.dogesound.club/checkholder/mates",
          {
            method: "POST",
            body: JSON.stringify({
              code,
  ...
  async checkEMateHolder(code) {
    ...
    if (address !== undefined) {
      ...
      try {
        const result = await fetch(
          "https://api.dogesound.club/checkholder/emates",
          {
            method: "POST",
            body: JSON.stringify({
              code,
