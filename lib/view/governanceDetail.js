...
class GovernanceDetail {
            ...
            click: async () => {
                if (this.proposalId !== undefined) {
                    if (forRadio.domElement.checked === true) {
                        await DSCGovernanceV3Contract_1.default.voteFor(this.proposalId, MateContract_1.default.address, this.mateList.selectedMateIds);
                        ViewUtil_1.default.waitTransactionAndRefresh();
                    }
                    if (againstRadio.domElement.checked === true) {
                        await DSCGovernanceV3Contract_1.default.voteAgainst(this.proposalId, MateContract_1.default.address, this.mateList.selectedMateIds);
                        ViewUtil_1.default.waitTransactionAndRefresh();
                    }
                }
            },
    ...
    async load(id) {
        ...
        voteCounts.append((0, skynode_1.el)(".for-votes", (0, skynode_1.el)("span.title", (0, msg_js_1.default)("GOVERNANCE_PROPOSAL_VOTE_FOR")), (0, skynode_1.el)("span.count", String(await DSCGovernanceV3Contract_1.default.getForVotes(id)))));
        voteCounts.append((0, skynode_1.el)(".against-votes", (0, skynode_1.el)("span.title", (0, msg_js_1.default)("GOVERNANCE_PROPOSAL_VOTE_AGAINST")), (0, skynode_1.el)("span.count", String(await DSCGovernanceV3Contract_1.default.getAgainstVotes(id)))));
        let content;
        ...
        if (remains > 0) {
            ...
            if (walletAddress !== undefined) {
                    ...
                    this.content.append((0, skynode_1.el)("a.cancel-button", (0, msg_js_1.default)("GOVERNANCE_CANCEL_PROPOSAL_BUTTON"), {
                        click: async () => {
                            new Confirm_1.default((0, msg_js_1.default)("GOVERNANCE_CANCEL_PROPOSAL_WARNING"), (0, msg_js_1.default)("GOVERNANCE_CANCEL_PROPOSAL_BUTTON"), async () => {
                                if (this.proposalId !== undefined) {
                                    await DSCGovernanceV3Contract_1.default.cancel(this.proposalId);
                                    ViewUtil_1.default.waitTransactionAndRefresh();
                                }
                            });
                        },
                ...
                for (let i = 0; i < mateBalance; i += 1) {
                    const promise = async (index) => {
                        ...
                        mates.push(mateId);
                        if (await DSCGovernanceV3Contract_1.default.getMateVoted(id, MateContract_1.default.address, mateId) === true) {
            ...
            this.voteForm.style({ display: "none" });
            const walletAddress = await Wallet_1.default.loadAddress();
            if (walletAddress === proposal.proposer && await DSCGovernanceV3Contract_1.default.matesBacked(this.proposalId) !== true) {
                this.container.append((0, skynode_1.el)("a.get-back-mates-button", (0, msg_js_1.default)("GOVERNANCE_GET_BACK_MATES_BUTTON"), {
                    click: async () => {
                        if (this.proposalId !== undefined) {
                            await DSCGovernanceV3Contract_1.default.getBackMates(this.proposalId);
                            ViewUtil_1.default.waitTransactionAndRefresh();
                        }
                    },
                }));
