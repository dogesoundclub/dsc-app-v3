...
class Layout {
    constructor() {
        ...
        })), (0, skynode_1.el)("a", { click: () => ViewUtil_1.default.go("/") }, (0, skynode_1.el)("img.logo", { align: "left", src: "/images/logo.svg", alt: "logo" })), new PCMenu_1.default(), (0, skynode_1.el)("a.bmcs", { click: () => ViewUtil_1.default.go("bmcs") }, "Go to BMCS >"), select = (0, skynode_1.el)("select.language-select", (0, skynode_1.el)("option", "🇰🇷 KOREAN", { value: "ko" }), {
            change: () => {
