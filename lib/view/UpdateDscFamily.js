...
class UpdateDscFamily {
    constructor(params) {
        ...
        }))), (0, skynode_1.el)(".input-container", (0, skynode_1.el)("label", (0, msg_js_1.default)("DSC_FAMILY_DETAIL_TITLE3")), this.descriptionInput = (0, skynode_1.el)("textarea", { placeholder: (0, msg_js_1.default)("DSC_FAMILY_DETAIL_TITLE2") })), (0, skynode_1.el)(".button-wrap", (0, skynode_1.el)("button", "수정하기", {
            click: async () => {
