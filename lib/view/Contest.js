...
class Contest {
    ...
    async load() {
        ...
        this.form?.delete();
        this.status.append((0, skynode_1.el)("p", (0, msg_js_1.default)("DOGESOUNDS_HOLIDAY_DESCRIPTION").replace(/{number}/, String(currentRound))), (0, skynode_1.el)("p", (0, msg_js_1.default)("DOGESOUNDS_HOLIDAY_DESCRIPTION_2")));
