...
class CheckMateHolder {
    constructor() {
        ...
        skynode_1.BodyNode.append(this.container = (0, skynode_1.el)(".check-holder", (0, skynode_1.el)("h1", "메이트 홀더 인증 페이지"), (0, skynode_1.el)("a.discord-login-button", "Login with Discord", {
            href: "https://discord.com/api/oauth2/authorize?client_id=1074340739930140682&redirect_uri=https%3A%2F%2Fdogesound.club%2Fcheckmateholder&response_type=code&scope=identify",
        })));
