...
const CollapsibleFilter_1 = __importDefault(
  require("../component//CollapsibleFilter")
);
const Layout_1 = __importDefault(require("./Layout"));
const MateParts_json_1 = __importDefault(require("./mates/MateParts.json"));
const Mates_json_1 = __importDefault(require("./mates/Mates.json"));
class Gallery {
  constructor() {
    this.selects = [];
    this.filter = {};
    ...
    Layout_1.default.current.content.append(
      (this.container = (0, skynode_1.el)(
        ...
        (0, skynode_1.el)(
          "header",
          (0, skynode_1.el)("h1", (0, msg_js_1.default)("GALLERY_TITLE"))
        ),
        (0, skynode_1.el)(
          "section",
          (0, skynode_1.el)(
            ...
            (0, skynode_1.el)(
              ...
              (0, skynode_1.el)(
                "button",
                (0, msg_js_1.default)("GALLERY_SEARCH_BUTTON")
              )
            ),
            ...Object.entries(MateParts_json_1.default).map(([key, values]) => {
              const select = new CollapsibleFilter_1.default(key, values, {
                click: (event, select) => {
            ...
            (0, skynode_1.el)(
              "a.reset-button",
              (0, msg_js_1.default)("GALLERY_RESET_FILTER_BUTTON"),
              {
                click: () => {
                  this.filter = {};
      ...
      if (this.query !== undefined) {
        ...
        if (
          ...
          mateNames[id]
            .replace(/ /g, "")
            .toLowerCase()
            .indexOf(this.query.replace(/ /g, "").toLowerCase()) !== -1
        ) {
          mates.push(id);
        }
      } else {
        ...
        if (Object.keys(this.filter).length > 0) {
          for (const [key, value] of Object.entries(this.filter)) {
            if (
              ...
              (value !== "None" || token.properties[key] !== undefined)
            ) {
              pass = false;
            }
          }
