...
class GovernanceOldDetail {
    constructor(params) {
        ...
        })), this.mateList = new MateList_1.default(true, false), (0, skynode_1.el)(".select", (0, skynode_1.el)("label.for", (0, skynode_1.el)("p.title", (0, msg_js_1.default)("GOVERNANCE_PROPOSAL_VOTE_FOR")), forRadio = (0, skynode_1.el)("input", {
            name: "governance-radio",
            type: "radio",
        })), (0, skynode_1.el)("label.against", (0, skynode_1.el)("p.title", (0, msg_js_1.default)("GOVERNANCE_PROPOSAL_VOTE_AGAINST")), againstRadio = (0, skynode_1.el)("input", {
            name: "governance-radio",
            type: "radio",
