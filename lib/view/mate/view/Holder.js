...
class Holder {
  constructor() {
    ...
    Layout_1.default.current.title = (0, msg_js_1.default)(
      "HOLDER_DISCORD_CERTIFICATION_BUTTON"
    );
    Layout_1.default.current.content.append(
      (this.container = (0, skynode_1.el)(
        ...
        (0, skynode_1.el)(
          ...
          (0, skynode_1.el)("h1", (0, msg_js_1.default)("HOLDER_TITLE1")),
          (0, skynode_1.el)(
            ".button-container",
            (0, skynode_1.el)("a", (0, msg_js_1.default)("YES_BUTTON"), {
              click: () => Wallet_1.default.connect(),
            }),
            (0, skynode_1.el)("a", (0, msg_js_1.default)("NO_BUTTON"), {
