...
class MateList extends skynode_1.ScrollableDomNode {
    constructor(selectable, rarity) {
        super((() => {
            ...
            return dom;
        })(), { childTag: "div", baseChildHeight: 176 }, (ids) => new MateLine_1.default(this, ids, this.mateNames, selectable, rarity));
    ...
    async load(mates, votedMates = []) {
        ...
        let index = 0;
        const mateData = [];
        skyutil_1.default.repeat(window.innerWidth < 800 ? Math.ceil(mates.length / 2) : Math.ceil(mates.length / 4), () => {
            const ids = [];
            skyutil_1.default.repeat(window.innerWidth < 800 ? 2 : 4, () => {
