...
class MateMessageList extends skynode_1.DomNode {
    constructor(mateId) {
        ...
        this.mateId = mateId;
        this.append((0, skynode_1.el)("table", (0, skynode_1.el)("thead", (0, skynode_1.el)("tr", (0, skynode_1.el)("th.block", "BLOCK #", { width: "15%" }), (0, skynode_1.el)("th.name", "NAME", { width: "15%" }), (0, skynode_1.el)("th.msg", "MSG", { width: "45%" }), (0, skynode_1.el)("th.address", "HOLDER ADDR", { width: "25%" }))), this.messageList = (0, skynode_1.el)("tbody")));
        this.loadMessages();
    }
    async loadMessages() {
