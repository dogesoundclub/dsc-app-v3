...
class MateList extends skynode_1.ScrollableDomNode {
    constructor(selectable, rarity) {
        super((() => {
            ...
            return dom;
        })(), { childTag: "div", baseChildHeight: window.innerWidth < 800 ? 64 : 90 }, (ids) => new MateLine(this, ids, this.mateNames, selectable, rarity));
...
//# sourceMappingURL=GalleryMateList.js.map