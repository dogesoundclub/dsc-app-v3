...
class CollapsibleFilter extends skynode_1.DomNode {
    constructor(title, values, onClick) {
        ...
        }), (0, skynode_1.el)("img", { src: "/images/shared/icn/icn_arrow_down.svg" })), this.content = (0, skynode_1.el)(".content", ...values.map((value) => (0, skynode_1.el)("button", value, { value }, onClick)), title === "Face" ? undefined : (0, skynode_1.el)("button", "None", { value: "None" }, onClick))));
    }
}
