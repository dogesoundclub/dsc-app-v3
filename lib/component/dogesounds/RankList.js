...
class RankList extends skynode_1.DomNode {
    constructor() {
        ...
        this.append((0, skynode_1.el)("table", (0, skynode_1.el)("thead", (0, skynode_1.el)("tr", (0, skynode_1.el)("th.id", "#", { width: "10%" }), (0, skynode_1.el)("th.votes", "VOTES", { width: "15%" }), (0, skynode_1.el)("th.dogesound", "DOGESOUND", { width: "75%" }))), this.rankList = (0, skynode_1.el)("tbody")));
        this.loadMessages();
    }
    async loadMessages() {
