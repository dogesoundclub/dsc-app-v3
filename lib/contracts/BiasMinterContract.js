...
const BiasMinter_json_1 = __importDefault(
  require("./abi/bias/artifacts/contracts/BiasMinter.sol/BiasMinter.json")
);
const Contract_1 = __importDefault(require("./Contract"));
class BiasMinterContract extends Contract_1.default {
  constructor() {
    super(
      "0x320d5525059E0916F310e87619C5dc91081B49f9",
      BiasMinter_json_1.default.abi
    );
  }
  async step() {
  ...
  async mint(count) {
    ...
    if (step === 0) {
      new Alert_1.default(
        "현재 민팅 진행중이 아닙니다. 민팅은 3월 17일 밤 8시부터 시작됩니다."
      );
    } else {
